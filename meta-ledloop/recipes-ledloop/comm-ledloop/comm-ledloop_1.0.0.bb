...
do_install() {
    ...
    ln -s ${LEDLOOP_APP_PATH}work-mode-backup.json "${D}${LEDLOOP_COMM_PATH}work-mode-backup.json"
    ln -s ${LEDLOOP_APP_PATH}figures-mode.json "${D}${LEDLOOP_COMM_PATH}figures-mode.json"
