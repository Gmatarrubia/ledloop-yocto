...
do_install:append () {
   ...
   install -D -m 600 ${WORKDIR}/wpa_supplicant-nl80211-wlan0.conf ${D}/settings/wpa_supplicant-nl80211-wlan0.conf
   ln -s /settings/wpa_supplicant-nl80211-wlan0.conf ${D}${sysconfdir}/wpa_supplicant/wpa_supplicant-nl80211-wlan0.conf
